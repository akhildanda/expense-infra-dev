resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.akhildev.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.akhildev.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.akhildev.online
      type    = "A"
